...
class InternalErrorWidget extends StatelessWidget {
  ...
  const InternalErrorWidget({
    Key? key,
    this.image = 'assets/images/technical_error.png',
    this.imageBuilder,
    this.title = 'Internal Error',
    this.titleBuilder,
    this.description =
        'Please update our app to the latest version available on the store.',
    this.descriptionBuilder,
    this.primaryTitle = 'Reload Page',
    this.primaryBuilder,
    this.primaryColor,
    this.onPrimary,
    this.secondaryTitle = 'Apps Store',
